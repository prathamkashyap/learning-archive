...
This plan keeps the learning archive organized while it grows from beginner notes into a useful engineering knowledge base.

## Phase 1: Repository Structure

Status: Complete

- Create topic directories for Git, GitHub, Markdown, Linux, VS Code, Docker, SQL, Networking, System Design, and Interview.
- Add a root README with purpose, contents, progress, and starting links.
...
- Explain repository lifecycle.
- Cover staging, commits, branches, merge vs rebase, remotes, undo commands, `.gitignore`, useful commands, and best practices.
- Add a Git section README as a table of contents.
...
- Keep filenames numbered when reading order matters.
